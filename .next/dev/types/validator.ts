...
// Validate ../../../src/app/api/paypal/capture-order/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/paypal/capture-order">> = Specific
  const handler = {} as typeof import("../../../src/app/api/paypal/capture-order/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../src/app/api/paypal/create-order/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/paypal/create-order">> = Specific
  const handler = {} as typeof import("../../../src/app/api/paypal/create-order/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
